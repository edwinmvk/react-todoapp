...
const reducer= (state: IStateDT, action: any)=> {
    switch(action.type){
        ...
        case 'delete':
            ...
            cop
            return {...state, activeTaskInfo: action.data}
        }                                                                                          
    return {...state}
}
...
const Provider = (props: Props) => {
    const [state, dispatch]= useReducer(reducer, { activeTaskInfo: activeTaskList })// the parameters of useReducer are: (i) a function that we perform on the state 
